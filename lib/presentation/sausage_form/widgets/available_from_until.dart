...
class AvailableUntilField extends StatelessWidget {
  const AvailableUntilField({super.key});
            ...
            showDatePicker(
              ...
              if (value != null) {
                context
                    ...
                    .add(SausageFormEvent.availableUntilChanged(value));
              }
            });
          },
          child: Column(
                  ...
                  children: [
                    Text(
                      Jiffy.parseFromDateTime(
                        state.sausage.availableUntil.fold(
                          DateTime.now,
                          (some) => some,
                        ),
